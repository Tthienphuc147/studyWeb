...
<div class="row mt">
    <div class="col-md-12">
        ...
        <div class="form-panel">
            <form role="form" class="form-horizontal style-form"  action="/admin/class/add" method="POST">
                {{ csrf_field() }}
                <div>
                    @if (count($errors)>0)
                ...
                <div class="col-lg-10">
                  <input type="text" placeholder="Nhập tên lớp" name="tenlophoc" class="form-control">
                </div>
                </div>
